...
const LoginLanding = () => {
  ...
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
      ...
      <div className='w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p12 lg:p-16 relative overflow-y-auto min-h-screen ' >

        <div className='w-full max-w-md animate-fade-in relative z-10' >
          {/* Header */}
            <div className='mb-10 text-center md:text-left' >
              <h2 className='text-3xl font-medium text-slate-900 tracking-tight mb-3' >Welcome Back</h2>
              <p className='text-slate-500' >Slect your portal to securely access the system</p>
            </div>
          ...
          <div className='mt-8 text-center md:text-left text-sm text-slate-400 ' >
            <p>© {new Date().getFullYear()} Farrukh Hussain. All rights reserved. </p>
          </div>
